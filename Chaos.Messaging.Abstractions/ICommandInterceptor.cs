...
/// </summary>
/// <typeparam name="T">
///     The type of the object that will be executing the commands
/// </typeparam>
public interface ICommandInterceptor<in T> where T: ICommandSubject
{
    /// <summary>
    ///     Parses the pieces of the command and executes the appropriate action
    /// </summary>
    /// <param name="source">
    ///     The object executing the command
    /// </param>
    ...
    ///         true
    ///     </c>
    ///     if the string is a command, otherwise
    ///     <c>
    ///         false
    ///     </c>
    /// </returns>
