...
public static class ObjectExtensions
{
    ...
    extension<T>(T obj)
    {
        ...
        /// </summary>
        public TReturn? TryCatch<TReturn>(Func<T, TReturn?> func, Func<Exception, TReturn?> exceptionHandler)
        {
            try
            {
                return func(obj);
        ...
        ///     only be used as a shorthand for unimportant things)
        /// </summary>
        public void TryCatch(Action action, Action<Exception> exceptionHandler)
        {
            try
            {
                action();
