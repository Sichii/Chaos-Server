...
public interface IAccessManager
{
    ...
    ///     The current password for the character
    /// </param>
    /// <param name="newPassword">
    ///     The new password for the character
    /// </param>
    ...
    /// </param>
    /// <param name="password">
    ///     The password for the character
    /// </param>
    ...
    ///         true
    ///     </c>
    ///     if the IP address should be allowed to connect, otherwise
    ///     <c>
    ///         false
    ///     </c>
    /// </returns>
    ...
    ///         true
    ///     </c>
    ///     if the provided credentials are correct, otherwise
    ///     <c>
    ///         false
    ///     </c>
    /// </returns>
