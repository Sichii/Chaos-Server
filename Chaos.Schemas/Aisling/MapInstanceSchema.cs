...
public sealed record MapInstanceSchema
{
    ...
    /// </summary>
    public required ICollection<WarpSchema> Warps { get; init; } = Array.Empty<WarpSchema>();

    /// <summary>
    ///     A collection of warps that take you to the world map
    /// </summary>
    public required ICollection<WorldMapWarpSchema> WorldMapWarps { get; init; } = Array.Empty<WorldMapWarpSchema>();
}