...
public static class StorageExtensions
{
    ...
    extension(IServiceCollection services)
    {
        ...
        /// </param>
        public void AddExpiringCache<T, TSchema, TOptions>(string? optionsSubsection = null) where T: class
                                                                                             where TSchema: class
        ...
        ///     The optional subsection name of the options to bind.
        /// </param>
        public void AddExpiringCacheImpl<T, TImpl, TOptions>(string? optionsSubsection = null) where T: class
        ...
        ///     The optional subsection name of the options to bind
        /// </param>
        public void AddLocalStorage(string? optionsSubsection = null)
        {
