...
/// <summary>
///     Represents the serialization of the <see cref="ServerOpCode.DisplayEditableNotepad" /> packet
/// </summary>
public sealed record DisplayEditableNotepadArgs : IPacketSerializable
{
    /// <summary>
