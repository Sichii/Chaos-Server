...
public sealed class WorldMapListView : ViewModelListView
{
    public WorldMapListView() => InitializeComponent();
    ...
    {
        var mapped = JsonContext.WorldMaps
                                .Objects
                                .Select(obj => obj.MapTo<WorldMapViewModel>())
    ...
    {
        var baseDir = JsonContext.WorldMaps.RootDirectory;
