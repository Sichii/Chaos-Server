...
public sealed class ItemTemplateListView : ViewModelListView
{
    public ItemTemplateListView() => InitializeComponent();
    ...
    {
        var mapped = JsonContext.ItemTemplates
                                .Objects
                                .Select(obj => obj.MapTo<ItemTemplateViewModel>())
                                .OrderBy(o => o.ViewModelIdentifier);
    ...
    protected override async void AddButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        var viewModel = new ItemTemplateViewModel
        {
            OriginalPath = path,
            Path = path
        };
