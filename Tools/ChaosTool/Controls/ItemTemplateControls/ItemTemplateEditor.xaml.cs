...
/// <summary>
///     Interaction logic for ItemTemplateEditor.xaml
/// </summary>
public sealed partial class ItemTemplateEditor
{
    public ObservableCollection<ListViewItem<ItemTemplateSchema, ItemTemplatePropertyEditor>> ListViewItems { get; }

    public ItemTemplateEditor()
    {
        ListViewItems = new ObservableCollection<ListViewItem<ItemTemplateSchema, ItemTemplatePropertyEditor>>();
    ...
    private void ListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        selected.Control ??= new ItemTemplatePropertyEditor(selected);
    ...
    {
        if (TemplatesView.SelectedItem is not ListViewItem<ItemTemplateSchema, ItemTemplatePropertyEditor> selected)
            return;
    ...
    private void DataGrid_AutoGeneratedColumns(object? sender, EventArgs e)
    {
        ...
        foreach (var property in TOOL_CONSTANTS.ItemTemplatePropertyOrder)
        {
    ...
    private void DataGrid_AutoGeneratingColumn(object? sender, DataGridAutoGeneratingColumnEventArgs e)
    {
        ...
        } else if (e.PropertyName.EqualsI(nameof(ItemTemplateSchema.ScriptKeys)))
        {
            e.Cancel = true;
            ...
            dataGrid.Columns.Add(column);
        } else if (!TOOL_CONSTANTS.ItemTemplatePropertyOrder.ContainsI(e.PropertyName))
            e.Cancel = true;
    }
    #endregion
}