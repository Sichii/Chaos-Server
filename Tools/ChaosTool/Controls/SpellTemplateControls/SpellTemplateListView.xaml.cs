...
public sealed class SpellTemplateListView : ViewModelListView
{
    public SpellTemplateListView() => InitializeComponent();
    ...
    {
        var mapped = JsonContext.SpellTemplates
                                .Objects
                                .Select(obj => obj.MapTo<SpellTemplateViewModel>())
    ...
    protected override void AddButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (folderBrowserDialog.ShowDialog() == DialogResult.OK)
        {
            ...
            var viewModel = new SpellTemplateViewModel
            {
                OriginalPath = path,
                Path = path
            };
