...
public sealed partial class SkillTemplateEditor
{
    public ObservableCollection<ListViewItem<SkillTemplateSchema, SkillTemplatePropertyEditor>> ListViewItems { get; }

    public SkillTemplateEditor()
    {
        ListViewItems = new ObservableCollection<ListViewItem<SkillTemplateSchema, SkillTemplatePropertyEditor>>();
    ...
    {
        var objs = JsonContext.SkillTemplates
                              .Objects
                              .Select(
                                  wrapper => new ListViewItem<SkillTemplateSchema, SkillTemplatePropertyEditor>
                                  {
    ...
    private void ListView_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        var selected = e.AddedItems
                        .OfType<ListViewItem<SkillTemplateSchema, SkillTemplatePropertyEditor>>()
                        .FirstOrDefault();
        ...
        selected.Control ??= new SkillTemplatePropertyEditor(selected);
    ...
    {
        if (TemplatesView.SelectedItem is not ListViewItem<SkillTemplateSchema, SkillTemplatePropertyEditor> selected)
            return;
    ...
    private async void AddButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        var template = new SkillTemplateSchema
        {
        ...
        var listItem = new ListViewItem<SkillTemplateSchema, SkillTemplatePropertyEditor>
        {
    ...
    private void DataGrid_AutoGeneratedColumns(object? sender, EventArgs e)
    {
        ...
        foreach (var property in TOOL_CONSTANTS.SkillTemplatePropertyOrder)
        {
    ...
    private void DataGrid_AutoGeneratingColumn(object? sender, DataGridAutoGeneratingColumnEventArgs e)
    {
        ...
        } else if (e.PropertyName.EqualsI(nameof(SkillTemplateSchema.ScriptKeys)))
        {
            ...
            dataGrid.Columns.Add(column);
        } else if (!TOOL_CONSTANTS.SkillTemplatePropertyOrder.ContainsI(e.PropertyName))
            e.Cancel = true;
    }
    #endregion
}