...
public sealed class SkillTemplateListView : ViewModelListView
{
    public SkillTemplateListView() => InitializeComponent();
    ...
    {
        var mapped = JsonContext.SkillTemplates
                                .Objects
                                .Select(obj => obj.MapTo<SkillTemplateViewModel>())
