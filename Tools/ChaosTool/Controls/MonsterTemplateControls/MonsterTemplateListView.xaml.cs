...
public sealed class MonsterTemplateListView : ViewModelListView
{
    public MonsterTemplateListView() => InitializeComponent();
    ...
    {
        var mapped = JsonContext.MonsterTemplates
                                .Objects
                                .Select(obj => obj.MapTo<MonsterTemplateViewModel>())
    ...
    protected override async void AddButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        if (folderBrowserDialog.ShowDialog() == DialogResult.OK)
        {
            ...
            var viewModel = new MonsterTemplateViewModel
            {
                OriginalPath = path,
                Path = path
            };
