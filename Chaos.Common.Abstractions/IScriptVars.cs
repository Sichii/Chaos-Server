...
ArgumentNullException – key is null.
    ...
    /// </summary>
    /// <param name="key">The key to locate in the IScriptVars</param>
    /// <returns><c>true</c> if the IScriptVars contains an element with the specified key, otherwise <c>false</c></returns>
