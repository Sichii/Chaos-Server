...
{
    /// <summary>
    ///     A shorthand way to add a script factory for a given <see cref="Chaos.Scripting.Abstractions.IScript"/> and <see cref="Chaos.Scripting.Abstractions.IScripted"/> type pair
    /// </summary>
