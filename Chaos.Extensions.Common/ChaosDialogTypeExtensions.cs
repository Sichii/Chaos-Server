...
public static class ChaosDialogTypeExtensions
{
    ...
    /// </returns>
    public static DialogType? ToDialogType(this ChaosDialogType value) => value switch
    {
    ...
    /// </returns>
    public static MenuType? ToMenuType(this ChaosDialogType value) => value switch
    {
