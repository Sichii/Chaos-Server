...
{
    /// <summary>
    ///     Removes the element with the specified key from the <see cref="IDictionary{TKey,TValue}"/> and makes the value available through the <paramref name="value"/> parameter.
    /// </summary>
