...
public static class StackExtensions
{
    ...
    /// <param name="stack">The stack to pop items from.</param>
    /// <param name="predicate">The condition to test each element against.</param>
    /// <returns>The first item that satisfies the <paramref name="predicate" />, or null if the stack is empty or no item satisfies the predicate.</returns>
