...
public class DefaultDamageFormula : IDamageFormula
{
    private readonly ImmutableArray<ImmutableArray<decimal>> ElementalModifierLookup = new[]
    {
        ...
        /*Fire*/     new[] { 2.32m, 0.58m, 0.66m,  1.74m, 1.03m, 0.93m, 0.83m,     1.74m, 0.83m,  1.88m }.ToImmutableArray(),
        /*Water*/    new[] { 2.32m, 1.74m, 0.58m,  1.03m, 0.66m, 0.93m, 0.83m,     0.66m, 1.88m,  0.93m }.ToImmutableArray(), 
        /*Wind*/     new[] { 2.32m, 0.66m, 1.03m,  0.58m, 1.74m, 0.93m, 0.83m,     1.03m, 0.50m,  0.83m }.ToImmutableArray(),
        /*Earth*/    new[] { 2.32m, 1.03m, 1.74m,  0.66m, 0.58m, 0.93m, 0.83m,     0.50m, 0.83m,  0.50m }.ToImmutableArray(),
        /*Holy*/     new[] { 2.32m, 0.76m, 0.76m,  0.76m, 0.76m, 0.58m, 1.48m,     0.50m, 0.76m,  0.76m }.ToImmutableArray(),
        /*Darkness*/ new[] { 2.32m, 1.25m, 1.25m,  1.25m, 1.25m, 1.48m, 0.58m,     1.48m, 1.25m,  1.25m }.ToImmutableArray(),
        /*Wood*/     new[] { 2.32m, 0.58m, 0.76m,  1.03m, 1.74m, 0.93m, 0.83m,     0.58m, 1.03m,  1.74m }.ToImmutableArray(),
