...
namespace Chaos
{
    ...
    internal static class CONSTANTS
    {
        ...
        internal static Location STARTING_LOCATION => (18000, 5, 6);
        internal static Location DEATH_LOCATION => (5031, 15, 15);
        internal static readonly ImmutableList<ushort> HAIR_SPRITES = new List<ushort>()
        {
            0,
        ...
        internal static readonly ImmutableList<ushort> DOOR_SPRITES = new List<ushort>()
        {
