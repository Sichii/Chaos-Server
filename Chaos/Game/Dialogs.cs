...
namespace Chaos
{
    ...
    internal sealed class Dialogs
    {
        ...
        internal Dialog CloseDialog() => new Dialog(DialogType.CloseDialog, 0, 0, false, false, "", null, 0, null, 0);
        ...
        internal Dialog ItemMenuDialog(ushort pursuitId, ushort dialogId, string message, List<KeyValuePair<string, ushort>> options) =>
        ...
        /// </summary>
        /// <param name="options">List of dialog options, and the dialog id they each lead to.</param>
        internal Dialog CreatureMenuDialog(ushort pursuitId, ushort dialogId, string message, List<KeyValuePair<string, ushort>> options) =>
