...
namespace Chaos
{
    ...
    internal sealed class Skill : PanelObject
    {
        ...
        /// </summary>
        internal Skill(ushort sprite, string name, TimeSpan baseCooldown, bool isBasic = false, Animation effectAnimation = default, TargetsType targetType = TargetsType.None, BodyAnimation bodyAnimation = 0, int baseDamage = 0)
