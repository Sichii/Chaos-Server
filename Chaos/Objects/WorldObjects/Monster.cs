...
namespace Chaos
{
    ...
    internal sealed class Monster : Creature
    {
        ...
        /// </summary>
        internal Monster(string name, Location location, ushort sprite, CreatureType type, TimeSpan updateInterval, uint health, Direction direction = Direction.South)
            : base(name, location, (ushort)(sprite + CONSTANTS.CREATURE_SPRITE_OFFSET), type, direction)
        {
