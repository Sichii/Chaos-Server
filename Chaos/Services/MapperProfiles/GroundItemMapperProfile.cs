...
public class GroundItemMapperProfile : IMapperProfile<GroundItem, GroundItemInfo>, IMapperProfile<Money, GroundItemInfo>
{
    /// <inheritdoc />
    GroundItem IMapperProfile<GroundItem, GroundItemInfo>.Map(GroundItemInfo obj) => throw new NotImplementedException();

    /// <inheritdoc />
    public GroundItemInfo Map(GroundItem obj)
        => new()
        {
            Id = obj.Id,
    ...
    /// <inheritdoc />
    public GroundItemInfo Map(Money obj)
        => new()
        {
            Id = obj.Id,
