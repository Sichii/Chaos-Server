...
public sealed class SpellMapperProfile : Profile
{
    private readonly ISimpleCache Cache;

    public SpellMapperProfile(ISimpleCache cache)
    {
        Cache = cache;

        CreateMap<Stats, SpellDto>()
            .ReverseMap();

        CreateMap<LearningRequirements, SpellDto>()
        ...
        CreateMap<SpellTemplate, SpellDto>()
