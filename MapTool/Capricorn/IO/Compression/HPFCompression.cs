    ...
    public class HPFCompression
    {
        public static byte[] Decompress(string file)
        {
            ...
            while ((int)num2 != 256)
            {
                ...
                uint num6 = num5;
                for (uint index = numArray5[(int)num5]; (int)num6 != 0 && (int)index != 0; index = numArray5[(int)num6])
                {
                    uint num7 = numArray5[(int)index];
                    uint num8 = numArray3[(int)num7];
                    if ((int)num8 == (int)index)
                    {
                        num8 = numArray4[(int)num7];
                        numArray4[(int)num7] = num6;
                    }
                    else
                        numArray3[(int)num7] = num6;
                    if ((int)numArray3[(int)index] == (int)num6)
                        numArray3[(int)index] = num8;
                    else
                        numArray4[(int)index] = num8;
                    numArray5[(int)num6] = (byte)num7;
                    numArray5[(int)num8] = (byte)index;
                    num6 = num7;
                }
                num2 = num5 + 4294967040U;
                if ((int)num2 != 256)
                {
                    numArray2[(int)num4] = (byte)num2;
                    ++num4;
                }
            }
            byte[] numArray6 = new byte[(int)num4];
        ...
        public static byte[] Decompress(byte[] hpfBytes)
        {
            ...
            while ((int)num2 != 256)
            {
                ...
                uint num6 = num5;
                for (uint index = numArray4[(int)num5]; (int)num6 != 0 && (int)index != 0; index = numArray4[(int)num6])
                {
                    uint num7 = numArray4[(int)index];
                    uint num8 = numArray2[(int)num7];
                    if ((int)num8 == (int)index)
                    {
                        num8 = numArray3[(int)num7];
                        numArray3[(int)num7] = num6;
                    }
                    else
                        numArray2[(int)num7] = num6;
                    if ((int)numArray2[(int)index] == (int)num6)
                        numArray2[(int)index] = num8;
                    else
                        numArray3[(int)index] = num8;
                    numArray4[(int)num6] = (byte)num7;
                    numArray4[(int)num8] = (byte)index;
                    num6 = num7;
                }
                num2 = num5 + 4294967040U;
                if ((int)num2 != 256)
                {
                    numArray1[(int)num4] = (byte)num2;
                    ++num4;
                }
            }
            byte[] numArray5 = new byte[(int)num4];
