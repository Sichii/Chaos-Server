...
/// <summary>
///     Maps objects from one type to another by utilizing
///     <see cref="Chaos.TypeMapper.Abstractions.IMapperProfile{T1,T2}" /> implementations
/// </summary>
public sealed class Mapper : ITypeMapper
{
    ...
    /// <summary>
    ///     Creates a function that maps one type to another, utilizing an
    ///     <see cref="Chaos.TypeMapper.Abstractions.IMapperProfile{T1,T2}" />
    /// </summary>
