...
public interface IEntityRepository
{
    ...
    /// </summary>
    /// <param name="path">The path to load the schema object from</param>
    /// <typeparam name="TSchema">The type of the schema object</typeparam>
    ...
    /// </summary>
    /// <param name="path">The path to load the schema object from</param>
    /// <param name="preMapAction">An optional action to perform on the schema before mapping</param>
    /// <typeparam name="T">The type to map the schema object to</typeparam>
    /// <typeparam name="TSchema">The type of the schema object</typeparam>
