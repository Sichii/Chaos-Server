...
public static class LoggerExtensions
{
    ...
    /// </summary>
    /// <param name="logger">The logger to add metrics to</param>
    ...
    /// </summary>
    /// <param name="logger">The logger to add the topics to</param>
    /// <param name="topics">The topics to add to the logger</param>
